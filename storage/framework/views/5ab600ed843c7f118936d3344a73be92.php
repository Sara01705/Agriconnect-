...
<div class="login-container">
    ...
    <div class="login-card">
        ...
        <form method="POST" action="<?php echo e(route('farmer.login.submit')); ?>">
        <?php echo csrf_field(); ?>
        ...
        <p class="text-center mt-2">
            <a href="<?php echo e(route('farmer.register')); ?>">New Farmer? Register</a>
        </p>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Xampp\htdocs\agriconnect-ai\resources\views/farmer/login.blade.php ENDPATH**/ ?>