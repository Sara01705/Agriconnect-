...
<h2>Hello <?php echo e($req->user->name); ?> 👋</h2>

<p style="font-size:16px;">
<p style="color:#777; font-size:14px;">
Order ID: #<?php echo e($req->id); ?>

</p>
<p style="color:#888; font-size:13px;">
Placed on: <?php echo e(now()->format('d M Y, h:i A')); ?>
...
<td style="padding:12px; border-bottom:1px solid #ddd;"><?php echo e($req->product->product_name); ?></td>
</tr>

<tr>
<td style="padding:12px; border-bottom:1px solid #ddd;">🔢 <b>Quantity</b></td>
<td style="padding:12px; border-bottom:1px solid #ddd;"><?php echo e($req->quantity); ?></td>
</tr>

<tr>
<td style="padding:12px;">💰 <b>Total Price</b></td>
<td style="padding:12px; color:#28a745; font-weight:bold;">₹<?php echo e($req->total_price); ?></td>
</tr>
...
👨‍🌾 Name: <?php echo e($req->product->farmer->name ?? 'Farmer'); ?><br>
📱Phone: <?php echo e($req->product->farmer->phone ?? 'Contact via platform'); ?>
...
<small>© <?php echo e(date('Y')); ?> AgriConnect Marketplace</small>
</td>
</tr>
...
</html><?php /**PATH E:\Xampp\htdocs\agriconnect-ai\resources\views/emails/order_accepted.blade.php ENDPATH**/ ?>